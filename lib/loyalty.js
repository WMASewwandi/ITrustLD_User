...
export const TIER_PROGRESS_REWARDS = {
  ...
  gold: ["USD 40 VOUCHERS", "EVERY MONTH"],
  diamond: ["USD 100 VOUCHERS", "EVERY MONTH"],
  vip: ["USD 140 VOUCHERS", "EVERY MONTH"],
  vvip: ["USD 200 VOUCHERS", "EVERY MONTH"],
};
...
export function getTierProgressReward(tier) {
  ...
  return TIER_PROGRESS_REWARDS[mapped] || [`UP TO ${tier?.pointsPerLot || 20} POINTS`, "PER LOT"];
}
