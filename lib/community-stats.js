...
export async function fetchCommunityStats() {
  try {
    ...
    return {
      ...
      completedDeposits: Number(data?.transactions?.completedDeposits) || 0,
      completedWithdrawals: Number(data?.transactions?.completedWithdrawals) || 0,
      paymentMethods: Number(data?.paymentMethods) || 0,
    };
  } catch {
    return {
      baseCount: 82000,
