    ...
    <section id="home-hero" className="relative isolate overflow-hidden">
      ...
      <div className="container-shell relative grid min-h-screen items-center gap-10 pb-12 pt-28 sm:pb-16 sm:pt-32 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8 xl:gap-12">
        <div className="hero-copy max-w-2xl">
          <p className="inline-flex items-center gap-2 rounded-full border border-theme-green-action/35 bg-[#0B1220]/55 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-white/90 backdrop-blur-md sm:text-xs">
          ...
          <h1 className="mt-6 text-3xl font-semibold leading-[1.15] tracking-tight text-white sm:text-4-5xl lg:text-5-6xl">
            ...
            <span className="mt-1 block">
              <span className="text-theme-green-action">Seamlessly</span>{" "}
              <span className="text-white">and</span>{" "}
              <span className="text-theme-green-action">Securely</span>
            </span>
          </h1>
        ...
        <div className="hero-visual relative mx-auto hidden w-full max-w-[440px] lg:block xl:max-w-[480px]">
          <div className="hero-card relative rounded-[1.35rem] border border-white/15 bg-[#0B1220]/55 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-2xl xl:p-7">
